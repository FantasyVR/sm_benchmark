"""
   We compare the performance of building a sparse matrix between 
   taichi sparse matrix builder and numpy, scipy.
"""
...
A = Abuilder.build()
e = time.time()
print(f"taichi sparse matrix build: {e-s}, triplets: {h-s}, build: {e-h}")
