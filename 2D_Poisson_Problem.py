"""
  We compare the performance of Scipy sparse solver and taichi sparse solver when solving a 367x3672 2D Poisson problem.
"""
import taichi as ti
import numpy as np
import scipy as sp
...
poissonProblem = scipy.io.loadmat('data/poisson2D.mat')['Problem']
...
col = Atriplets.col
data = Atriplets.data
Abuilder = ti.linalg.SparseMatrixBuilder(N, N, max_num_triplets=3000)
